# whenever a new text file is added to an S3 bucket, parses the text file and gets the author and title of the text file (book)
# Then tags with S3 tags the file accordingly in S3
