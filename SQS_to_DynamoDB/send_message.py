# this script was used to run on an EC2 to use the Faker library to generate random text in SQS Queue messages that are later to be processed by the Lambda function
